        ...
        <tr>
            ...
            <td class="tdright">
                <asp:DropDownList ID="ddlState" runat="server" AutoPostBack="True">
                    <asp:ListItem Value="24">审核通过</asp:ListItem>
                    <asp:ListItem Value="22">退回返修</asp:ListItem>
                    <asp:ListItem Value="23">退稿</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
...
&nbsp;
                <asp:Button ID="Bt_cancel" runat="server" CausesValidation="False" 
                    CssClass="menuBig" PostBackUrl="~/admin/doclist.aspx" Text="取消" />
            </td>
        </tr>
    </table>
</asp:Content>
