  ...
  <TR>
    ...
    <TD background=../images/new_002.jpg><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        ...
        <tr>
          <td height="35">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 主编您好，欢迎使用长江大学期刊社在线投稿系统&nbsp;&nbsp;&nbsp; <a class="STYLE1" href="#" language="javascript" onclick="if (confirm('确认要离开本系统?')){;href='../Default.aspx';target='_top';}">   安全退出</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE2">日期：</span><font color="#666666">
