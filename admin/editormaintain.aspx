<%@ Page Language="C#" MasterPageFile="~/system.master" AutoEventWireup="true" CodeFile="editormaintain.aspx.cs" Inherits="admin_editormaintain" Title="无标题页" %>
                                                ...
                                                <tr>
                                                    <td class="tdright">
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                            CellPadding="1" CellSpacing="2" CssClass="gvstyle" DataKeyNames="editorID" 
                                                            ...
                                                            <Columns>
                                                                <asp:HyperLinkField DataNavigateUrlFields="editorID" 
                                                                    DataNavigateUrlFormatString="editordetail.aspx?editorID={0}" HeaderText="登录名" 
                                                                    NavigateUrl="~/admin/editordetail.aspx" DataTextField="editorID">
                                                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:HyperLinkField>
                                                                <asp:BoundField DataField="editorName" HeaderText="编辑姓名" 
                                                                    SortExpression="editorName" ReadOnly="True">
                                                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                ...
                                                                <asp:BoundField DataField="editorPhone" HeaderText="联系电话" 
                                                                    SortExpression="editorPhone" ReadOnly="True">
                                                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="editorMail" HeaderText="电子邮件" 
                                                                    SortExpression="editorMail" ReadOnly="True">
                                                                    <HeaderStyle HorizontalAlign="Center" Width="120px" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
