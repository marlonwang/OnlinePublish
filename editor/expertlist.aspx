<%@ Page Language="C#" MasterPageFile="~/system.master" AutoEventWireup="true" CodeFile="expertlist.aspx.cs" Inherits="editor_authorlist" Title="无标题页" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="审核" Text="审核" DataNavigateUrlFields="docID" 
                    DataNavigateUrlFormatString="reassess.aspx?docID={0}" 
