<%@ Page Language="C#" MasterPageFile="~/system.master" AutoEventWireup="true" CodeFile="modifylist.aspx.cs" Inherits="author_doclists" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            CssClass="gvstyle" GridLines="Horizontal" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="docID" 
                    DataNavigateUrlFormatString="upload.aspx?docID={0}" HeaderText="上传稿件" 
                    NavigateUrl="~/author/upload.aspx" Text="上传">
                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
            </Columns>
